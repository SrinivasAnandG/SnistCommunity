...
<body>
	<?php
		if(isset($_SESSION['user_id'])&&isset($_SESSION['username']))
		{
			...
			$query="select * from group_members where user_id='$user_id'";
			...
			if($execute)
			{
				if(mysqli_num_rows($execute)>0)
				{
					...
					{
						$row2=$object->getGroupDetails($conn,$row[0]);
						echo '<br/><div class="row">';
						echo '<div class="col-xs-2"><lable>'.$row2[1].'</lable> </div>';
						echo '<div class="col-xs-10"><a href="view_group.php?group_id='.$row2[0].'" class="btn btn-info" role="button">view_group</a></div>';
						echo '</div><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>';
					}
				}
				else
				{
					echo '<h2>You are not yet in any existing group try to create your own group and add people ....!</h2><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>';
				}
			}
			else
			{
